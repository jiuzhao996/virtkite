...
| 06 | [06-系统测试与验证.md](06-系统测试与验证.md) | 第六章 系统测试 | 测试环境与工具、功能测试、单元测试 13 例（`-race`，两个包）、安全验证、虚拟化语义验证、稳定性验证、真实 KVM 演示、问题与修复记录（P0/P1/P2 三批） |
| 07 | [07-部署与运维.md](07-部署与运维.md) | 附录 | 环境要求、Docker（Dockerfile 关键点）/源码部署、配置（含生产密钥强校验）、前端产物探测、存储卷与克隆运维、排错 |
| 08 | [08-总结与展望.md](08-总结与展望.md) | 第七章 总结与展望 | 工作总结（含三轮加固与方法论结论）、后续工作（多宿主机/孤儿卷/监控/混合云等） |
